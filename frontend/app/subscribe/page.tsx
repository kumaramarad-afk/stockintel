  ...
  return (
    <div className="py-8">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-3 text-gsr-muted">Five free reports each month. Pro unlocks every metric, plus real-time alerts.</p>
      </div>
      <div className="mx-auto mt-10 grid max-w-4xl gap-6 md:grid-cols-2">
        <article className="glass-card rounded-2xl p-6">
          ...
          <ul className="mt-4 space-y-2 text-sm text-gsr-muted">
            <li>5 full report previews per month</li>
            <li>Consensus direction, names, and star ratings</li>
            <li>First two lines of each briefing</li>
          </ul>
        ...
        <article className="glass-card rounded-2xl border-gsr-accent/40 p-6 shadow-glass">
          ...
          <ul className="mt-4 space-y-2 text-sm text-gsr-muted">
            <li>Unblurred targets, risks, and catalysts</li>
