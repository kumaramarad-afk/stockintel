...
export default function RegisterPage() {
  ...
  return (
    <div className="mx-auto max-w-md py-10">
      ...
      <p className="mt-2 text-gsr-muted">Save your research desk and subscribe when you are ready.</p>
      <form onSubmit={onSubmit} className="glass-card mt-8 space-y-4 rounded-2xl p-6">
        ...
        <label className="block text-sm">
          <span className="text-gsr-muted">Password (8+ characters)</span>
          <input
            type="password"
            required
            minLength={8}
      ...
      <p className="mt-4 text-sm text-gsr-muted">
        ...
        <Link href="/login" className="text-gsr-accent hover:text-white">
          Sign in
        </Link>
      </p>
    </div>
