  ...
  return (
    <div className="space-y-8">
      <section className="glass-card rounded-2xl p-8">
        <p className="text-xs font-semibold uppercase tracking-[0.28em] text-gsr-accent">Premium briefing</p>
        ...
        <p className="mt-2 max-w-3xl text-gsr-muted">
          Daily briefing at 8 AM UTC with tape movers, insider Form 4 prints, a macro watch, and one deep-dive
          ticker that opens the same institutional report on Research. Educational only — not financial advice.
        </p>
        {!subscribed ? (
          <div className="mt-6 flex flex-wrap items-center gap-3">
            ...
            >
              {busy ? "Redirecting…" : "Unlock Premium — $12/mo"}
            </button>
            <p className="text-sm text-gsr-muted">Unlimited research, weekday briefing, and archive.</p>
          </div>
        ) : (
          <div className="mt-6 rounded-2xl border border-gsr-border bg-black/20 p-4 text-sm">
            <p className="font-semibold text-gsr-accent">Premium briefing is active</p>
      ...
      <section className="glass-card rounded-2xl p-6">
        ...
        {!subscribed && today?.ticker && (
          <p className="mt-4 text-sm text-gsr-muted">
            Guests can still open the public research preview. The full briefing, archive, and unlimited desk are part of
            Premium ($12/mo).
          </p>
        )}
      </section>
